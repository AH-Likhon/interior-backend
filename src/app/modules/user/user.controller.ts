...
const getAllUser = catchAsync(async (req: Request, res: Response) => {
  ...
  const filters = pick(req.query, userFilterableFields);
  const options = pick(req.query, paginationFields);
  const result = await UserService.getAllUserFromDB(filters, options, role);
  sendResponse(res, {
    success: true,
    message: "Fetched users successfully",
    statusCode: httpStatus.OK,
...
const updateSingleUser = catchAsync(async (req: Request, res: Response) => {
  ...
  const id = req.params.id;
  const payload = req.body;
  const result = await UserService.updateSingleUserToDB(id, role, payload);
  sendResponse(res, {
    success: true,
    message: "Updated single user successfully",
    statusCode: httpStatus.OK,
...
const updateMyProfile = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await UserService.updateMyProfileToDB(id, data);
  sendResponse(res, {
    success: true,
